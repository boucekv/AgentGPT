...
class AutonomousAgent {
  ...
  sendLoopMessage() {
    this.sendMessage({
      ...
      value:
        this.modelSettings.customApiKey !== ""
          ? `This agent has been running for too long (250 Loops). To save your wallet, and our infrastructure costs, this agent is shutting down. In the future, the number of iterations will be configurable.`
